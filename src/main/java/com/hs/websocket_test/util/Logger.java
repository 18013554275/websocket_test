...
public class Logger {
	 ...
	 * 构造方法，初始化Log4j的日志对象
	 */
	private Logger(org.jboss.logging.Logger log4jLogger) {
		logger = log4jLogger;
	}
	...
	public static Logger getLogger(Class classObject) {
		return new Logger(org.jboss.logging.Logger.getLogger(classObject));
	}
	...
	public static Logger getLogger(String loggerName) {
		return new Logger(org.jboss.logging.Logger.getLogger(loggerName));
	}
	...
	public org.jboss.logging.Logger getLog4jLogger() {
		return logger;
	}
